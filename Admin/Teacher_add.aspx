...
<link rel="stylesheet" type="text/css" href="../static/h-ui.admin/css/style.css" />
    ...
    <link href="../css/Common.css" rel="stylesheet" type="text/css" />
     ...
     .c_1{width:100%;margin:0px auto;height:200px;}
...
<body>
    ...
    <div>
       ...
       <div class="c_1">
        ...
        <div class="tj">
        <asp:Button class="btn btn-primary radius" ID="Button1" runat="server" onclick="ImageButton1_Click" Text="提交" Width="100px" />
            </div>
