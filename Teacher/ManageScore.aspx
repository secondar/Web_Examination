          ...
          <asp:Repeater ID="Repeater_dh" runat="server" DataSourceID="SqlDataSource1">
            <ItemTemplate>
              <tr class="text-c">
                ...
                <td><%#Eval("mscore") %></td>
                <td><%#Eval("jscore") %></td>
                <td><a title="删除" href="javascript:;" onclick="member_del(this,'<%#Eval("ScoreID") %>')" class="ml-5" style="text-decoration:none">删除</a></td>
              </tr>
            </ItemTemplate>
          </asp:Repeater>
        ...
        layer.confirm('确认要删除吗？', function (index) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    setTimeout("location.href = 'ManageScore.aspx'", 2000);
                },
                error: function (data) {
