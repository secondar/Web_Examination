    ...
    <div class="page-container">
      <div class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="txtTitle" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="txtAnswerA" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="txtAnswerB" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="txtAnswerC" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="txtAnswerD" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:DropDownList ID="ddlAnswer" runat="server" Width="80px">
        ...
        <div class="row cl">
          <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2" style="text-align:center;">
            ...
            <a title="取消" href="ManageDanXuan.aspx" class="btn btn-default radius" style="text-decoration:none">取消</a> <br />
            <br />
          </div>
        </div>
      </div>
