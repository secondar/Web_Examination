      ...
      <table class="table table-border table-bordered table-hover table-bg table-sort">
        ...
        <tbody>
          <asp:Repeater ID="Repeater_dh" runat="server" DataSourceID="SqlDataSource1">
            <ItemTemplate>
              <tr class="text-c">
                <td><input type="checkbox" value="<%#Eval("c_id") %>" name="checkbox"></td>
                <td><%#Eval("c_id") %></td>
                <td><%#Eval("c_name") %></td>
                <td><%#Eval("c_date") %></td>
                <td><a title="编辑" href="javascript:;" onclick="show('编辑课程','ManageCourse_update.aspx?c_id=<%#Eval("c_id") %>','300','300','300')" Class="btn btn-primary radius" style="text-decoration:none">编辑</a> <a title="删除" href="javascript:;" onclick="Delete(this,'<%#Eval("c_id") %>')" class="btn btn-danger radius" style="text-decoration:none">删除</a></td>
              </tr>
            </ItemTemplate>
          </asp:Repeater>
...
<script type="text/javascript">
    function datadelAll() {
        ...
        layer.confirm('确认要删除选中项目吗？', function (index) {
            $.ajax({
                url: "ManageCourse.aspx/DeleteAll",
                type: "post",
                data: "{'s':'" + s2 + "'}",
                dataType: 'json',
                ...
                success: function (data) {
                    ...
                    setTimeout("location.href = 'ManageCourse.aspx'", 1000);
                },
                error: function (data) {
