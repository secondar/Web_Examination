...
<form id="form" runat="server">
  <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 试题 <span class="c-gray en">&gt;</span> 单选题录入 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
  <div id="add" runat="server">
    <div class="page-container">
      <div class="form form-horizontal" id="form-article-add">
        <div class="row cl">
          <label class="form-label col-xs-4 col-sm-2"><span class="c-red"></span>添加单选题：</label>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="TextBox2" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="TextBox3" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="TextBox4" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          ...
          <div class="formControls col-xs-8 col-sm-9">
            <asp:TextBox ID="TextBox5" runat="server" TextMode="MultiLine" class="input-text" Width="900px"  Height="50px"></asp:TextBox>
        ...
        <div class="row cl">
          <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2" style="text-align:center;">
            <a href="ImportDanxuan.aspx?flag=1" class="btn btn-default radius">批量导入</a>　　
