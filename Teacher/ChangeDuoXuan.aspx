  ...
  <div id="add" runat="server">
    <div class="page-container">
      <div class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
          <label class="form-label col-xs-4 col-sm-2">修改前答案：</label>
          <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
          <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2" style="text-align:center;">
            ...
            <a title="取消" href="ManageDuoXuan.aspx" class="btn btn-default radius" style="text-decoration:none">取消</a> <br />
            <br />
          </div>
        </div>
      </div>
