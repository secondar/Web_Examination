...
<form id="form1" runat="server">
  <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 课程管理 <span class="c-gray en">&gt;</span> 章节管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
  <div class="page-container">
    <div class="text-c"> 查询条件:
      <asp:DropDownList ID="DropDownList_flag" runat="server" class="input-text" style="margin-top:2px" Width="90px">
        <asp:ListItem Value="Name">章节章明</asp:ListItem>
          ...
          <asp:Repeater ID="Repeater_dh" runat="server" DataSourceID="SqlDataSource1">
            <ItemTemplate>
              <tr class="text-c">
                ...
                <td><%#Eval("Chapter") %></td>
                <td><%#Eval("c_name") %></td>
                <td><a title="编辑" href="javascript:;" onclick="show('编辑章节','ManageChapter_update.aspx?ID=<%#Eval("ID") %>','300','300','300')" Class="btn btn-primary radius" style="text-decoration:none">编辑</a> <a title="删除" href="javascript:;" onclick="Delete(this,'<%#Eval("ID") %>')" class="btn btn-danger radius" style="text-decoration:none">删除</a></td>
              </tr>
            </ItemTemplate>
          </asp:Repeater>
...
<script type="text/javascript">
    function datadelAll() {
        ...
        layer.confirm('确认要删除选中项目吗？', function (index) {
            $.ajax({
                url: "ManageChapter.aspx/DeleteAll",
                type: "post",
                data: "{'s':'" + s2 + "'}",
                dataType: 'json',
                ...
                success: function (data) {
                    ...
                    setTimeout("location.href = 'ManageChapter.aspx'", 1000);
                },
                error: function (data) {
